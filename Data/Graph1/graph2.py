...
ax1.plot(df1['Time [min]'], df1['1B: O2 concentration [M]'], color=cmap_conc_1b(0.8), label="File 1B O2 Conc")
ax1.plot(df2['Time [min]'], df2['1B: O2 concentration [M]'], color=cmap_conc_1b(0.6), label="File 2B O2 Conc")
ax1.plot(df3['Time [min]'], df3['1B: O2 concentration [M]'], color=cmap_conc_1b(0.4), label="File 3B O2 Conc")
...
ax2.plot(df1['Time [min]'], df1['1B: O2 slope neg. [pmol/(s*mL)]'], color=cmap_slope_1b(0.8), label="File 1B O2 Slope")
ax2.plot(df2['Time [min]'], df2['1B: O2 slope neg. [pmol/(s*mL)]'], color=cmap_slope_1b(0.6), label="File 2B O2 Slope")
ax2.plot(df3['Time [min]'], df3['1B: O2 slope neg. [pmol/(s*mL)]'], color=cmap_slope_1b(0.4), label="File 3B O2 Slope")
...
ax2.set_ylabel('O2 Slope [pmol/(s*mL)]', color='red')
